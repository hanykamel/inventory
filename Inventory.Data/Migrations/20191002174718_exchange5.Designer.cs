...
namespace Inventory.Data.Migrations
{
    ...
    [Migration("20191002174718_exchange5")]
    partial class exchange5
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inventory.Data.Entities.ExchangeOrder", b =>
                {
                    ...
                    b.Property<int?>("ExchangeOrderStatusNewId");
                    ...
                    b.HasIndex("ExchangeOrderStatusNewId");
            ...
            modelBuilder.Entity("Inventory.Data.Entities.ExchangeOrderStatusNew", b =>
                {
                    b.Property<int>("Id");
                    ...
                    b.ToTable("ExchangeOrderStatusNew");
                });
            ...
            modelBuilder.Entity("Inventory.Data.Entities.ExchangeOrder", b =>
                {
                    b.HasOne("Inventory.Data.Entities.Budget", "Buget")
                        .WithMany("ExchangeOrder")
                        .HasForeignKey("BugetId")
                        .HasConstraintName("FK_ExchangeOrder_Budget");

                    b.HasOne("Inventory.Data.Entities.ExchangeOrderStatusNew", "ExchangeOrderStatusNew")
                        .WithMany("ExchangeOrder")
                        .HasForeignKey("ExchangeOrderStatusNewId")
                        .HasConstraintName("FK_ExchangeOrder_ExchangeOrderStatusNew");
